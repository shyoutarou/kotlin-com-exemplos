fun main() {
   ...
   // TODO("Criar uma variável mutável para armazenar o $resultado")
    ...
    for (i in numeroRomano!!.indices) {
        ...
        when{
            resultado == 0 && atual >= proximo -> resultado = atual + proximo;
            resultado != 0 && atual < proximo -> resultado = resultado - atual + (proximo-atual)
            resultado == 0 && atual < proximo -> resultado = proximo - atual
            resultado != 0 && atual >= proximo -> resultado = proximo + resultado
        }
    }
